<?php
	...
	if($_SERVER['REQUEST_METHOD']=="POST"){
		...
		if(!empty($Email) && !empty($Password) && !is_numeric($Email)){
			...
			$query ="INSERT INTO all_users(User_Name,Mobile_Number,Email,DOB,User_Type,Password)VALUES('$UserName','$Mobile','$Email','$DOB','$UserType','$Password')";
...
<style>
div {
  background-image:url('style/00.jpg');
...
<form method="POST">
	...
	<center><a style="color:blue;font-size:18px;text-decoration-line:underline;font-weight:bold" href="homepage.html">back to home</a></center></h4>
	</center>	
	</form>	
   </div>
