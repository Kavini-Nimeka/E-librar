...
<table border="2" width="100%">
	  ...
	  <tbody>
		<?php 
			$query="SELECT * FROM all_users WHERE user_type='admin'";
			$result=mysqli_query($conn,$query);
